...
const LAUNCHER_MODULES: readonly LauncherModule[] = [
	...
	},
	{
		...
		titleTh: "คำขอเปลี่ยนแปลงระบบ",
		titleEn: "System change requests",
		descriptionTh: "ดูและติดตามคำขอเปลี่ยนแปลงระบบ",
		descriptionEn: "View and track system change requests",
	...
	},
	{
		...
		href: "/change-requests/approvals",
		groupTh: "คำขอเปลี่ยนแปลงระบบ",
		groupEn: "System change requests",
		groupCode: "change-request",
		iconKey: "check",
		gatewayOnly: true,
		leaveRoles: ["grantor_head_l1", "grantor_deputy", "grantor_director", "admin"],
	},
	{
		id: "admin-users",
